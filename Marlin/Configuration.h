...
#define STRING_CONFIG_H_AUTHOR "(Gines Cruz 03-12-2021 SKR 1.4 Turbo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Good Stuff 01"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 97.76, 97.49, 4092.31, 421.82 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 2, 120 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 40, 5, -0.78 }
